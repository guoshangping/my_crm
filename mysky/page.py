    ...
    def ret_html(self):
        ...
        for i in range(show_tags_left, show_tags_right + 1):
            ...
            if i == self.page_num:
                ...
                page_tag_html += '<li><a href="?{0}">{1}</a></li>'.format( self.params.urlencode(),
                                                                               i)
...
# class MyPage(object):
#
#     def __init__(self, page_num, all_data_amount, url_prefix, request, per_page_data=10, page_show_tags=11):
#
#         '''
#         :param page_num: 当前页码
#         :param all_data_amount:  总的数据量
...
#             self.params["page"] = i  # self.params={"page":2,"a":1,"b":2}
#             if i == self.page_num:
#                 page_tag_html += '<li class="active"><a href="/{0}/?{1}">{2}</a></li>'.format(self.url_prefix,
#                                                                                               self.params.urlencode(),
#                                                                                               i)
#             else:
#                 page_tag_html += '<li><a href="/{0}/?{1}">{2}</a></li>'.format(self.url_prefix, self.params.urlencode(),
#                                                                                i)
#         page_tag_html = start + front_page_tag + first_page_tag + page_tag_html + last_page_tag + next_page_tag + end
#         return page_tag_html
